...
data<-read.csv('/dfs2/yassalab/rjirsara/ConteCenterScripts/Conte-One/audits/rawdata/Age+Sex.csv')
...
data$AgeAtScan<-as.factor(data$AgeAtScan)
...
write.csv(data,'/dfs2/yassalab/rjirsara/ConteCenterScripts/Conte-One/audits/datasets/n275_Age+Sex_20190829.csv')
