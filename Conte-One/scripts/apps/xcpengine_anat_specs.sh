...
###################################################################
#fc-36p_despike.dsn fc-36p_25scrub.dsn fc-36p_50scrub.dsn fc-acompcor.dsn fc-aroma.dsn fc-aroma_gsr.dsn fc-36p.dsn
...
SCRIPT_RESID_COR_FCON=$DIR_LOCAL_SCRIPTS/evalqc/visual_residcor_distdep.sh
