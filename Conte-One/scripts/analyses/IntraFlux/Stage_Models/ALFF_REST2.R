...
covaPath <- "/dfs7/dfs2/yassalab/rjirsara/ConteCenterScripts/Conte-One/analyses/IntraFlux/n138_IntraFlux.mods/ALFF.csv" 
inputPath <- "/dfs7/dfs2/yassalab/rjirsara/ConteCenterScripts/Conte-One/analyses/IntraFlux/n138_IntraFlux.mods/REST2.csv"
...
DATASETS<-DATASETS[grepl("ALFF_REST2",DATASETS)]
