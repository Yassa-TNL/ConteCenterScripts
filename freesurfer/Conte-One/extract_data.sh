...
cat TEMP1_volume_ASEG.txt | sed s@"Measure:volume"@"sub,ses"@g | sed s@"${inputdir_One}/"@""@g | \
  sed s@"${inputdir_DBK}/"@""@g | sed s@"_tp"@","@g > ${outdir}/n${count}_Aseg_volume_${TODAY}.csv
...
##################################################
  ...
  cat raw1_Aparc-Destrieux_rh_${property}.txt | sed s@"rh.aparc.a2009s.${property}"@"sub,ses"@g | sed s@"${inputdir_One}/"@""@g | 
  sed  s@"${inputdir_DBK}/"@""@g | sed s@"_tp"@","@g > raw2_Aparc-Destrieux_rh_${property}.txt

  cat raw1_Aparc-Destrieux_lh_${property}.txt | sed s@"lh.aparc.a2009s.${property}"@"sub,ses"@g | sed s@"${inputdir_One}/"@""@g | \
  sed s@"${inputdir_DBK}/"@""@g | sed s@"_tp"@","@g > raw2_Aparc-Destrieux_lh_${property}.txt
