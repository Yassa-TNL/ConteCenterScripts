...
DIR_LOCAL_APPS=/dfs2/yassalab/rjirsara/ConteCenterScripts/ORE/apps
DIR_LOCAL_DATA=/dfs2/yassalab/rjirsara/ConteCenterScripts/ORE/datasets
...
DESIGN_FILES="fc-36p_despike.dsn fc-aroma.dsn fc-36p.dsn"
