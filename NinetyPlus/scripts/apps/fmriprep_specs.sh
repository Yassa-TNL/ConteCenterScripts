...
SCRIPT_FMRIPREP=${DIR_LOCAL_SCRIPTS}/fmriprep_preproc_pipeline.sh
OUTPUT_SPACES="MNI152NLin2009cAsym"
OPT_ICA_AROMA=TRUE
OPT_STOP_FIRST_ERROR=TRUE
...
if [[ -f $SCRIPT_HEADMOTION ]] ; then
	...
	echo "####################################################"
	Rscript $SCRIPT_HEADMOTION $DIR_LOCAL_APPS/fmriprep $DIR_LOCAL_DATA
fi
