...
inputPath <- "/dfs2/yassalab/rjirsara/ConteCenterScripts/Conte-One/analyses/IntraFlux/n138_IntraFlux.mods/EVCont.csv"
...
DATASETS<-DATASETS[grepl("_EVCont_",DATASETS)]
